# METADATA
# title: SoFREP v4 — Status of Forces Report Policy (Dense/Data-Driven)
# description: Validates SoFREP structure, enums, cross-references, risk scoring, and readiness.
# authors:
